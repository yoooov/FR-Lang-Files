...
$lang = array(
    ...
    'invites_message2' => " This is a private community please read over the rules once you have confirmed your invite. Regards, ",
    ...
    'invites_verification' => "Verification",
    //captcha
    'invites_spam' => "NO SPAM! Wait 10 seconds and then refresh page",
    'invites_refresh' => "Click to refresh image",
    'invites_image_alt' => "Captcha image",
    'invites_pin' => "PIN:",
    'invites_noscript' => "Javascript must be enabled to login and use this site.",
    'invites_year' => "Year",
    'invites_month' => "Month",
    'invites_jan' => "January",
    'invites_feb' => "Febuary",
    ...
    'invites_jul' => "July",
    'invites_aug' => "August",
    'invites_sep' => "September",
    'invites_oct' => "October",
    'invites_nov' => "November",
    'invites_dec' => "December",
    'invites_day' => "Day",
    'invites_timez' => "Timezone",
    'invites_q1' => 'Mother\'s birthplace',
    'invites_q2' => 'Best childhood friend',
    'invites_q3' => 'Name of first pet',
    'invites_q4' => 'Favorite teacher',
    'invites_q5' => 'Favorite historical person',
    'invites_q6' => 'Grandfather\'s occupation',
    'invites_select' => 'Select Hint Question',
    'invites_enter' => 'Enter hint answer',
    'invites_this_answer' => 'This answer will be used to reset your password in case you forget it.',
    'invites_this_answer1' => 'Make sure its something you wont forget!',
    'invites_birth' => 'Birthday',
    'invites_open' => "Signup is open",
    'invites_closed' => "Signup is closed",
    'invites_click' => "Now click the button marked",
    'invites_x' => "X",
    'invites_click1' => "to complete the sign up!",
